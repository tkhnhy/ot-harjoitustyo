...
class TestHighscores(unittest.TestCase):
    ...
    def test_read_file(self):
        ...
        self.assertEqual(scorelist, sorted(self.rows, key=lambda row: row[1], reverse=True))
    ...
    def test_write_file(self):
        ...
        self.assertEqual(self.highscore_handler.readscore(), sorted(ref_rows, key=lambda row: row[1], reverse=True))