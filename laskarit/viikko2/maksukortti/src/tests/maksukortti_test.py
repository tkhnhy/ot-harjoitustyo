...
class TestMaksukortti(unittest.TestCase):
	...
	def test_lataa_rahaa_ei_lisaa_negatiivista(self):
		self.kortti.lataa_rahaa(-5)
		
		self.assertEqual(self.kortti.saldo_euroina(), 10.0)
	
	def test_syo_edullisesti_voi_ostaa_minimi_rahalla(self):
		kortti = Maksukortti(250)
		kortti.syo_edullisesti()
		
		self.assertEqual(kortti.saldo_euroina(), 0.0)
	
	def test_syo_maukkaasti_voi_ostaa_minimi_rahalla(self):
